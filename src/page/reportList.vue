  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="举报类型" prop="title"></el-table-column>
        <el-table-column label="举报内容" prop="content"></el-table-column>
        <el-table-column label="被举报人" prop="dealUsername"></el-table-column>
        <el-table-column label="被举报视频">
          <template slot-scope="scope">
            <!-- <a type="primary" :href="'http://120.79.143.66:8080//'+ scope.row.videoPath" target="_blank">点我观看</a> -->
            <el-button type="primary" icon="el-icon-video-play" @click="watchVideo(scope.row)">点我观看</el-button>
          </template>
        </el-table-column>
        <el-table-column label="提交用户" prop="submitUsername"></el-table-column>
        <el-table-column label="举报日期" prop="createDate"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getBgms() {
      const bgms = await getReportsList({
